//Correspond to B question 
//Command to run from a terminal:
//hadoop jar /home/cloudera/Desktop/WordCount3.jar WordCount3 input output
...
public class WordCount3 extends Configured implements Tool
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		int result = ToolRunner.run(conf, new WordCount3(), args);
