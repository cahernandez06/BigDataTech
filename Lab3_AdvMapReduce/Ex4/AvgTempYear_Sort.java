...
public class AvgTempYear_Sort extends Configured implements Tool
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		int result = ToolRunner.run(conf, new AvgTempYear_Sort(), args);
	...
	public int run(String[] args) throws Exception
	{
		...
		job.setJarByClass(AvgTempYear_Sort.class);
