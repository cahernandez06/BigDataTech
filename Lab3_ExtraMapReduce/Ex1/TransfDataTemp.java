...
public class TransfDataTemp extends Configured implements Tool
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		int result = ToolRunner.run(conf, new TransfDataTemp(), args);
	...
	public int run(String[] args) throws Exception
	{
		...
		job.setJarByClass(TransfDataTemp.class);
